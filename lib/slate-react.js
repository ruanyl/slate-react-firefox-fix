...
var selectionsEqual = function selectionsEqual(sel1, sel2) {
...
var Content = function (_React$Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.nativeSelection = {}, _this.tmp = {
      ...
      if (selection.isUnset && rangeCount && _this.isInEditor(anchorNode) && selectionsEqual(_this.nativeSelection, native)) {
